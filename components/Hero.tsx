  ...
  return (
    <section className="relative flex min-h-[80vh] items-center md:min-h-screen">
      ...
      <div className="section-padding relative z-10 mx-auto w-full max-w-7xl py-32">
        <p className="text-label mb-4 text-white/80">Tire Protection Sealant</p>
        ...
        <p className="mt-6 max-w-xl text-base text-white/90 md:text-lg">
          High-performance tire sealant that shields your tires from the inside out —
          sealing punctures instantly so you stay on the road.
        </p>
